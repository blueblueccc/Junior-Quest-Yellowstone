...
import UIKit
import CoreLocation
class SecondViewController: UIViewController,CLLocationManagerDelegate, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    var imageNames: [String] = ["Black Bear","Elk","Moose","Mountain Goat","Wolf","Coyote","Bison","Chipmunk","Bighorn Sheep","Deer"]
    var totalPoint = 0
    ...
    @IBAction func clickedSwitch(_ sender:UISwitch){
        ...
        if cell.pointSwitch.isOn{
            ...
            if UserDefaults.standard.integer(forKey: "totalPointsOfPage2") > 0 {
                totalPoint = UserDefaults.standard.integer(forKey: "totalPointsOfPage2")
            }
            totalPoint += 1
            ...
            UserDefaults.standard.set(totalPoint, forKey: "totalPointsOfPage2")
            UserDefaults.standard.set(numberOfFoundedImages, forKey: "totalPointsOfPages")
            
            // save founded image
            let indexPath = self.collectionView!.indexPath(for: cell)
            print((indexPath! as NSIndexPath).row)
            UserDefaults.standard.set(true, forKey: String(format: "switch%d",(indexPath! as NSIndexPath).row + 10))
            ...
            UserDefaults.standard.set(false, forKey: String(format: "switch%d",(indexPath! as NSIndexPath).row + 10))
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.pointSwitch.isOn = UserDefaults.standard.bool(forKey: String(format: "switch%d", (indexPath as NSIndexPath).row + 10))
        ...
        cell.infoButton.tag = (indexPath as NSIndexPath).row + 11
    ...
    func infoButtonPress(_ sender:UIButton){
        ...
        title.text = String(format: imageNames[sender.tag - 11])
