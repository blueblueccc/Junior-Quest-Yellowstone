//
//  GeysersViewController.swift
//  Eye-Spy
//
//  Created by son on 11/13/16.
...
class GeysersViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        btnCheck.isSelected = UserDefaults.standard.bool(forKey: "switch" + String(0))
    ...
    @IBAction func onBtnInfo(_ sender: Any) {
        ...
        content.text = readInfoTextFromFile(carousel.currentItemIndex) as String
    ...
    func tapImageUncheck() {
        ...
        if btnCheck.isSelected == false {
            ...
            // save founded image
            UserDefaults.standard.set(true, forKey: String(format: "switch%d",carousel.currentItemIndex))
            ...
            UserDefaults.standard.set(false, forKey: String(format: "switch%d",carousel.currentItemIndex))
...
extension GeysersViewController: iCarouselDelegate, iCarouselDataSource {
    ...
    func carouselCurrentItemIndexDidChange(_ carousel: iCarousel) {
        ...
        btnCheck.isSelected = UserDefaults.standard.bool(forKey: "switch" + String(carousel.currentItemIndex))
        if btnCheck.isSelected != true {
...
extension GeysersViewController: CLLocationManagerDelegate {
