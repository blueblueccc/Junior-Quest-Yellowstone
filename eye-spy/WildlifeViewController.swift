...
class WildlifeViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        btnCheck.isSelected = UserDefaults.standard.bool(forKey: "switch" + String(10))
    ...
    @IBAction func onBtnInfo(_ sender: Any) {
        ...
        content.text = readInfoTextFromFile(carousel.currentItemIndex + 10) as String
    ...
    func tapImageUncheck() {
        ...
        if btnCheck.isSelected == false {
            ...
            // save founded image
            UserDefaults.standard.set(true, forKey: String(format: "switch%d",carousel.currentItemIndex + 10))
            ...
            UserDefaults.standard.set(false, forKey: String(format: "switch%d",carousel.currentItemIndex + 10))
...
extension WildlifeViewController: iCarouselDelegate, iCarouselDataSource {
    ...
    func carouselCurrentItemIndexDidChange(_ carousel: iCarousel) {
        ...
        btnCheck.isSelected = UserDefaults.standard.bool(forKey: "switch" + String(carousel.currentItemIndex + 10))
        if btnCheck.isSelected != true {
...
extension WildlifeViewController: CLLocationManagerDelegate {
